...
**Branch**: `1-rabbitmq-abstraction` | **Date**: 2026-03-20 | **Spec**: ../1-rabbitmq-abstraction/spec.md
**Input**: Feature specification from `/specs/1-rabbitmq-abstraction/spec.md`
...
- Serializer strategy and EasyNetQ compatibility
...
- Serialization incompatibility: mitigate by using EasyNetQ default serializer as the default and providing adapter
